...
public class ObjectManager {
    ...
    public void setObjects() {
        ...
        int levelNum = gp.tileM.currentLevel;
        ...
        // Apple trees — level-aware placement
        int[][] appleTreePositionsL3 = {
            {496, 748}, {990, 748}, {520, 1048}, {1147, 248}, {1147, 320},
            {1147, 374}, {1147, 538}, {1082, 668}, {505, 540}
        };
        int[][] appleTreePositionsL2 = {
            {200, 400}, {2550, 400}, {200, 1750}, {2550, 1750}, {150, 950},
            {2600, 950}, {1440, 200}, {1440, 1850}
        };
        int[][] appleTreePositionsL1 = {
            {150, 200}, {2650, 200}, {150, 1850}, {2650, 1850}
        };

        int[][] applePositions = (levelNum == 3) ? appleTreePositionsL3 :
                                  (levelNum == 2) ? appleTreePositionsL2 :
                                  appleTreePositionsL1;

        for (int i = 0; i < applePositions.length; i++) {
            objAppleTree[i] = new ObjAppleTree(gp, 2.7);
            objAppleTree[i].worldX = applePositions[i][0];
            objAppleTree[i].worldY = applePositions[i][1];
        }
        ...
        // Underground shelter — level-aware placement
        int[][] shelterSpotsL3 = {
        ...
        int[][] shelterSpotsL2 = {
            {300, 500}, {2600, 500}, {300, 1700}, {2600, 1700},
            {1440, 300}, {1440, 1800}, {200, 900}, {2550, 900},
            {500, 400}, {2300, 1600}, {1200, 1500}, {1800, 600}
        };
        int[][] shelterSpotsL1 = {
            {150, 250}, {2650, 250}, {150, 1750}, {2650, 1750},
            {500, 500}, {2400, 1500}, {300, 1200}, {2300, 200},
            {600, 300}, {2500, 1700}, {1000, 1600}, {2000, 400}
        };
        int[][] shelterSpawnSpots = (levelNum == 3) ? shelterSpotsL3 :
                                     (levelNum == 2) ? shelterSpotsL2 :
                                     shelterSpotsL1;
        ...
        int[][] riddleL2 = {
            {300, 600}, {2550, 600}, {300, 1650}, {2550, 1650},
            {200, 1200}, {2600, 800}, {1440, 400}, {1440, 1750},
            {500, 900}, {2400, 400}, {800, 1500}, {2200, 1400},
            {400, 300}, {2650, 1100}, {1000, 500}, {1800, 1200},
            {600, 1300}, {2300, 700}
        };
        int[][] riddleL1 = {
            {150, 350}, {2650, 350}, {150, 1650}, {2650, 1650},
            {200, 800}, {2600, 1200}, {150, 1200}, {2650, 800},
            {500, 200}, {2400, 1800}, {600, 1500}, {2500, 300},
            {300, 1300}, {2550, 900}, {700, 400}, {2200, 1700},
            {400, 1100}, {2300, 500}
        };
        int[][] riddleSpawnSpots = (levelNum == 3) ? riddleL3 :
                                    (levelNum == 2) ? riddleL2 :
                                    riddleL1;
    ...
    public void spawnCollectibles() {
        ...
        int appleIndex = 0;
        int[] offsets = {-30, 0, 30};
        int applesPerTree = gp.diffM.getApplesPerTree();
        ...
        int woodCount = gp.diffM.getWoodCount();
        int actualWoodCount = Math.min(woodCount, woodAllPositions.length);

        for (int i = 0; i < actualWoodCount && i < woodItems.length; i++) {

            woodItems[i] = new ObjWoodItem(gp);
            woodItems[i].worldX = woodAllPositions[i][0] + rand.nextInt(60) - 30;
            woodItems[i].worldY = woodAllPositions[i][1] + rand.nextInt(60) - 30;
        }
    }
